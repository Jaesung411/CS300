...
public class Book {
	...
	/**
	 * Override Object's equals method for correct work
	 * 
	 * @return true if all of their attributes have identical values
	 */
	@Override
	public boolean equals(Object b) {
		// Check if the input is Book object, and compared the attributes
		if (b instanceof Book) {
			Book otherBook = (Book) b;
			// Check if all Attributes are same with given object's Attributes
			if (this.ID == otherBook.ID && this.getAuthor() == otherBook.getAuthor()
					&& this.getPageCount() == otherBook.getPageCount() && this.getTitle() == otherBook.getTitle()) {
				return true;
			}
		}
