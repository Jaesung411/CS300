public class ClimbingTrackerTester {
   ...
   * 
   * @return true if there are no other success grades in the empty array, if the success grades
   *         occupy the spaces in array, if the success grades occupy the spaces fully and false
   *         otherwise.
   */
   ...
   * 
   * @return true if there are no other fail grades in the empty array, if the success grades occupy
   *         the spaces in array, if the success grades occupy the spaces fully and false otherwise.
   */
  ...
  /**
   * Check the value that is divided by the history-length according to the average grade which are
  ...
  public static boolean testGetStats() {
    ...
    // Comparison
    if (!(ClimbingTracker.getStats(sendArray1, sendSize1, failArray1, failSize1, 2)
        .equals(expected1))) {
      System.out.println("failed test1");
      return false;
    }
    ...
    // Comparison
    if (!(ClimbingTracker.getStats(sendArray2, sendSize2, failArray2, failSize2, 3)
        .equals(expected2))) {
   ...
   * 
   * @return true if - displays 5times, + 3 displays times in the first scenario and if - displays 5
   *         times, + displays 5tiems as well, but false otherwise.
   */
  public static boolean testGetHistogram() {
    ...
    // Comparison
    if (!(ClimbingTracker.getHistogram(sendArray1, sendSize1, failArray1, failSize1)
        .equals(expected1))) {
      System.out
          .println(ClimbingTracker.getHistogram(sendArray1, sendSize1, failArray1, failSize1));
    ...
    // Comparison
    if (!(ClimbingTracker.getHistogram(sendArray2, sendSize2, failArray2, failSize2)
        .equals(expected2))) {
      System.out
          .println(ClimbingTracker.getHistogram(sendArray2, sendSize2, failArray2, failSize2));
      System.out.println("failed test2");
      return false;
    }
